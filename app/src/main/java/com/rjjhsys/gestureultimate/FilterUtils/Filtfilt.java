package com.rjjhsys.gestureultimate.FilterUtils;


import com.rjjhsys.gestureultimate.mathUtil.Mat;
...
public class Filtfilt {
	...
	public static void filter(ArrayList<Double> B, ArrayList<Double> A,
		...
		if (A.size() == 0)
			throw new RuntimeException("A ����Ϊ�գ�");
		boolean flagA = true;
		...
		if (flagA) {
			throw new RuntimeException("A ��������Ҫ��һ������Ϊ�㣡");
		}
		if (A.get(0) == 0) {
			throw new RuntimeException("A �����һ��Ԫ�ز���Ϊ�㣡");
		}
